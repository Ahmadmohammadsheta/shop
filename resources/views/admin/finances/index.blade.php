...
@section('content')
<a href="{{route('finances.create')}}" class="btn btn-success btn-lg">اضافة</a>
    <div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    ...
                    <form id="delete{{$item->id}}" action="{{route('finances.destroy',$item->id)}}" method="POST">@csrf @method('delete')</form>
                </td>
              </tr>
              @empty
              <tr>
